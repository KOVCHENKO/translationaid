...
public class WordPairFacadeImpl implements WordPairFacade, Serializable {
    ...
    public List<String> getEquivalent(String firstEquivalent) {
        String hql = "select W.semanticUnitTwo from WordPair W where W.semanticUnitOne = :firstEquivalent";
        Query q = em.createQuery(hql);
        q.setParameter("firstEquivalent", firstEquivalent);
